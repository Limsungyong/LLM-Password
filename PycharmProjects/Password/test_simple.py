...
if __name__ == "__main__":
    ...
    target_files = [
        "Simple/Claude/claude_simple_fixed_passwords.csv",  # Claude 결과
        "Simple/Gemini/gemini_simple_fixed_passwords.csv",  # Gemini 결과
        "Simple/GPT/gpt_simple_fixed_passwords.csv",  # GPT 결과
        "Simple/Perplexity/perplexity_simple_fixed_passwords.csv"  # Perplexity 결과
    ]
